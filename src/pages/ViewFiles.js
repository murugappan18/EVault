...
import { decryptFile } from "../FileEncDec";
              ...
              <div key={index} className="viewfiles-card">
                ...
                {file.cid ? (
                  <button
                    ...
                    onClick={() => {
                      setLoadingIndex(index); // or file.filename if that's unique
                      decryptFile(user, file, () => setLoadingIndex(null));
                    }}
                    disabled={loadingIndex === index}
                  >
                    {loadingIndex === index ? "Fetching & Decrypting..." : "Download File"}
                  </button>
                ) : (
